...
public class ModItemsRegister {
    public static final Item INCOMPLETE_ELOTE = registerItem("incomplete_elote",
            new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(3).saturationModifier(0.3f).build())));
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, Identifier.of(CulturalCreatorsMod.MOD_ID, name), item);
    }
